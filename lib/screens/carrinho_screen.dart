...
import 'package:feiragreen_flutter/models/cart_item_model.dart';
...
class _CarrinhoScreenState extends State<CarrinhoScreen>
  ...
  Future<void> _loadCartItems() async {
    try {
      ...
      final cartItemsData = await DatabaseHelper.instance.getCartItemsByUser(
        widget.userId,
      );
      ...
      for (var cartItemData in cartItemsData) {
        final cartItem = CartItem.fromMap(cartItemData);
