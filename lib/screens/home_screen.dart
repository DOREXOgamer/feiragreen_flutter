...
import 'package:feiragreen_flutter/screens/profile_screen.dart';
import 'package:feiragreen_flutter/screens/carrinho_screen.dart';
import 'package:feiragreen_flutter/screens/busca_screen.dart';
import 'package:feiragreen_flutter/screens/address_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  Future<void> _loadProducts() async {
    try {
      ...
      final productsData = await DatabaseHelper.instance.getAllProducts();
  ...
  Future<void> _loadUserData() async {
    try {
      ...
      final userData =
          await DatabaseHelper.instance.getUserByEmail(widget.user['email']);
  ...
  Future<void> _goToCar() async {
    await Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => CarrinhoScreen(userId: widget.user['id']),
      ),
    );
    await _loadProducts();
    await _loadCartItemCount();
  ...
  Future<void> _addToCart(Product product) async {
    try {
      final cartItems = await DatabaseHelper.instance.getCartItemsByUser(
        widget.user['id'],
      );
