...
import 'package:feiragreen_flutter/utils/permission_handler.dart';
...
class _ProductManagementScreenState extends State<ProductManagementScreen> {
  ...
  Future<void> _loadProducts() async {
    final productsData =
        await DatabaseHelper.instance.getProductsByUser(widget.userId);
    setState(() {
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                if (product == null) {
                  ...
                  await DatabaseHelper.instance
                      .updateProduct(newProduct.toMap());
                }
